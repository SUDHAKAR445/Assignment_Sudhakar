...
public class HashTable
{
	public static void main(String[] args)
	{
		...
		// adding elemnets to the hashtable
		
		// In hashtable key value doesn't be a duplicate
		...
		System.out.println("Check the specified value present in the hastable more than one times or not with different keys : "+hashTable.containsValue(1));
		
		//Return the value to which the specified key is mapped
		System.out.println("The value to which the specified key is mapped : " +hashTable.get(1));
		...
		//Clone() method is used to take the shallow copy of an hashtable
		Hashtable <Integer,Integer> hashTableClone = new Hashtable<>();
		hashTableClone = (Hashtable)hashTable2.clone();
		System.out.println("Hashtable clone result : " + hashTableClone);
		
		
		//EntrySet method used to get the set view of the entries
